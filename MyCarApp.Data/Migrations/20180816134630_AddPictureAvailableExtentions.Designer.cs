...
namespace MyCarApp.Data.Migrations
{
    ...
    [Migration("20180816134630_AddPictureAvailableExtentions")]
    partial class AddPictureAvailableExtentions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyCarApp.Models.Vehicles.PictureValidExtentions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasIndex("Extention")
                        .IsUnique()
                        .HasFilter("[Extention] IS NOT NULL");

                    b.ToTable("PictureValidExtentions");
                });
            ...
            modelBuilder.Entity("MyCarApp.Models.Vehicles.PicturePath", b =>
                {
                    b.HasOne("MyCarApp.Models.Vehicles.PictureValidExtentions", "Extention")
                        .WithMany()
